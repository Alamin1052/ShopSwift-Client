    ...
    return (
        <div className="flex items-center justify-center p-10">
            <div className="bg-white/70 backdrop-blur-xl p-10 rounded-2xl shadow-xl w-full max-w-md text-gray-800 relative overflow-hidden border border-white/40">
                ...
                <p className="text-center text-sm mb-8 text-gray-600">Register to continue</p>
                ...
                <button className="w-full py-3 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition text-gray-700 font-medium">
